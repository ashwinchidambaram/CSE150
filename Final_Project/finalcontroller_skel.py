  ...
  def do_final (self, packet, packet_in, port_on_switch, switch_id):
    ...
    if ip is None: #if non-ip packet
    	...
    	if switch_id is 1:
    		...
    		#print 'ip at s2'
    		if port_on_switch is 8: #from h2
    			msgAction = of.ofp_action_output(port = 3) #send to s4
    			msg.actions.append(msgAction)
    			#print 'sent to s4'
    		elif port_on_switch is 3: #from s4
    			msgAction = of.ofp_action_output(port = 8) #send to h2
    			msg.actions.append(msgAction)
    			#print 'sent to h2'

    	elif switch_id is 3:
    		#print 'ip at s3'
    		if port_on_switch is 8: #from h3
    			msgAction = of.ofp_action_output(port = 3) #send to s4
    			msg.actions.append(msgAction)
    			#print 'sent to s4'
    		elif port_on_switch is 3: #from s4
    			msgAction = of.ofp_action_output(port = 8) #send to h3
    			msg.actions.append(msgAction)
    			#print 'sent to h3'

    	elif switch_id is 5:
    		#print 'ip at s5'
    		if port_on_switch is 8: #from h5
    			msgAction = of.ofp_action_output(port = 3) #send to s4
    			msg.actions.append(msgAction)
    			#print 'sent to s4'
    		elif port_on_switch is 3: #from s4
    			msgAction = of.ofp_action_output(port = 8) #send to h5
    			msg.actions.append(msgAction)
    			#print 'sent to h5'
    	elif switch_id is 4:
    		#print 'ip at s4'
